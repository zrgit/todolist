...
export default {
  ...
  methods: {
     ...
     **/
    getUserInfo() {
      this.$http.get("http://api.zr816.top/api/userInfo").then(res => {
        if (res.data.code) {
    ...
    addTodo() {
      ...
      if (todo) {
        ...
        this.$http
          .post("http://api.zr816.top/api/user/todoList", data)
          .then(res => {
            if (res.data.code === 1) {
              const list = this.listArr.todoList;
              this.$message({
    ...
    remove(item) {
      ...
      this.$http
        .post("http://api.zr816.top/api/user/DestroyTodoList", data)
        .then(res => {
          if (res.data.code === 1) {
            const list = this.listArr.todoList;
            this.$message({
    ...
    updateTodoList(item, listName = "todoList") {
      ...
      this.$http
        .post("http://api.zr816.top/api/user/updateTodoList", data)
        .then(res => {
          if (res.data.code === 1) {
    ...
    getTodoList(list) {
      this.$http
        .get("http://api.zr816.top/api/user/getTodoList?status=" + list.status)
        .then(res => {
          if (res.data.code === 1) {
